| SNO | Titles                                                                                             | Domain                                           |
|-----|-----------------------------------------------------------------------------------------------------|--------------------------------------------------|
| 1   | Therapist chatbot for Medical assistance: A Django framework                                      | Healthcare                                       |
| 2   | College chatbot for A complete digitization for sharing resources starting from course details to study materials for the enrolled students: A web-based solution using Django framework | Education, Web Development                        |
| 3   | Edu course: A complete solution for education institutions to go online in the current pandemic situation using the Django framework. | Education                                       |
| 4   | A Django framework for personality prediction system using Machine learning and Big 5 personality traits. | Machine Learning, Personality Prediction         |
| 5   | Heart disease prediction using ANN approaches: A web application using the Django framework.        | Healthcare, Web Development                      |
| 6   | A Django framework for disease risk prediction & CNN-based recommendation system.                   | Healthcare, Machine Learning                     |
| 7   | Django framework for Prediction Of Cardiac Arrhythmia Type Using Clustering And Regression Approach (P-Ca-Cra). | Healthcare, Machine Learning                |
| 8   | Placement Prediction using Machine Learning techniques.                                             | Machine Learning, Education                      |
| 9   | Django framework for travel agencies: A web application.                                            | Travel                                           |
| 10  | Face recognition for student attendance management.                                                | Facial Recognition, Education                   |
| 11  | Cybersecurity Attacks in Vehicular Sensors                                                         | Cybersecurity                                   |
| 12  | Anomaly Detection using Machine Learning Techniques in Wireless Sensor Networks                   | Machine Learning, Sensor Networks               |
| 13  | Determination of medicinal leaf properties using Artificial Intelligence                           | Healthcare, Agriculture                        |
| 14  | Implementation of Image Processing Technique to distinguish Weed using Deep learning                | Agriculture, Image Processing                  |
| 15  | Intracranial Hemorrhage Detection in CT Scans using Deep Learning                                  | Healthcare, Medical Imaging                    |
| 16  | Real-Time and Accurate Drone Detection in a Video with a Static Background using YOLO V5            | Computer Vision, Object Detection              |
| 17  | Face Landmark Prediction Using Machine Learning                                                    | Facial Recognition, Machine Learning           |
| 18  | AI Vision Based Social Distancing Detection Predicting Severity Of Parkinson's Disease Using Deep Learning | Healthcare, Social Distancing, Parkinson's Disease |
| 19  | Computer Vision for Attendance and Emotion Analysis in School Settings                              | Computer Vision, Education                     |
| 20  | Facial Mask Detection using Semantic Segmentation                                                  | Computer Vision, Image Segmentation            |
| 21  | Age and Gender Prediction using Deep Convolutional Neural Networks                                 | Machine Learning, Gender Prediction            |
| 22  | Image Caption Generation using Deep Learning                                                        | Natural Language Processing, Deep Learning     |
| 23  | Efficient Masked Face Recognition Method during the COVID-19 Pandemic                               | Facial Recognition, Pandemic Response          |
| 24  | Parkinson Disease Detection Using Deep Neural Networks based on artificial intelligence           | Healthcare, Neurology, AI                      |
| 25  | Raspberry pi based fruit detection & calorie estimation using convolution neural network (CNN)    | Agriculture, Health                             |
| 26  | A deep learning approach for Detection of Alzheimer’s Disease Using Analysis of Hippocampus Region from MRI Scan | Healthcare, Neurology, AI            |
| 27  | Predict pneumonia disease on chest x-ray using classified CNN                                      | Healthcare, Medical Imaging, CNN               |
| 28  | Handwritten Digit Recognition Using Deep Learning                                                  | Image Recognition, Handwriting Recognition     |
| 29  | Music recommendation based on face emotion recognition                                             | Music, Emotion Recognition                     |
| 30  | An AI based Chatbot application for industries to support and scale business using Flask framework  | AI, Chatbot, Flask Framework                   |
| 31  | Computer-Aided Segmentation of Liver Lesions in CT Scans Using Cascaded Convolutional Neural Networks and Genetically Optimized Classifier | Healthcare, Medical Imaging, AI |
| 32  | Plant disease prediction using Deep learning techniques                                            | Agriculture, Machine Learning                 |
| 33  | Bird Species Identification using Neural networks                                                   | Ornithology, Machine Learning                  |
| 34  | Brain Tumor classification using Neural Networks                                                   | Healthcare, Medical Imaging, AI                |
| 35  | What to play next? A RNN-based music Recommendation system                                         | Music, Recommendation System, RNN             |
...
| 72  | Tourist Advice app React Real time                                                                  | Travel, Web Development, React                 |
...
| 109 | Movie Ticket Booking System                                                                        | Entertainment, E-commerce, Web Development   |
...
| 146 | Face Sketch Elements                                                                                | Art, Computer Vision                          |
...
| 183 | Pneumonia Detection                                                                                | Healthcare, Medical Imaging, Fullstack       |
